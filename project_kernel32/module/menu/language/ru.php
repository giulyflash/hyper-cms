...
$error = array(
	...
	'edited seccessfully' => 'Редактирование меню "$name" прошло успешно',
	'added seccessfully' => 'Меню "$name" успешно добавлено',
	'deleted seccessfully' => 'Меню "$name" успешно удалено',
